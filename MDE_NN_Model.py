...
class MDE_Model(nn.Module):
    def __init__(self, config, sampler, embeddings):
        ...
        self.beta2 = 0
        self.w = nn.Parameter(
            (torch.FloatTensor(np.random.uniform(-1 / 5, 1 / 5, [4]))))
...
class Experiment(object):
    ...
    def load2(self, epoch):
        ...
        self.model.embeddings.relation_embedding3 = embeddings.relation_embedding1
    ...
    def load3(self, epoch):
        ...
        self.model.embeddings.relation_embedding5 = embeddings.relation_embedding1
